...
\begin{document}
	...
	\paragraph{Ticket}
	\begin{itemize}
		\item Ticket per entrare nel gioco che hanno una validità $\lft{1}$ ore $\to$ crittografia più forte;
		\item Ticket per utilizzare un servizio che hanno una validità $\lft{2}$ minuti $\to$ crittografia leggera;
	\end{itemize}
	$$\lft{1}>\lft{2}$$
